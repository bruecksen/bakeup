...
python manage.py tenant_command dumpdata --all --schema=localhost workshop.Product workshop.ProductPrice workshop.ProductHierarchy workshop.Instruction taggit.Tag taggit.TaggedItem > bakeup/workshop/fixtures/demo_products.json
