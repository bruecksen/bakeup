...
urlpatterns = [
    path("unsubscribe/<int:user_id>/", unsubscribe_user, name="unsubscribe"),
    path(
        "unsubscribe/<int:user_id>/<int:list_id>/", unsubscribe_user, name="unsubscribe"
    ),
    path("subscribe_api/", subscribe_api, name="subscribe_api"),
    path("activate/<int:contact_pk>/<token>/", activate, name="activate"),
