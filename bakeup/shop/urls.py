...
from bakeup.shop.views import customer_order_template_update, production_day_abo_products, CustomerOrderTemplateDeleteView, CustomerOrderTemplateListView, customer_order_add_or_update, CustomerOrderListView, ProductionDayListView, redirect_to_production_day_view, ProductListView, ShopView, ProductionDayWeeklyView
from bakeup.users.views import LoginView, TokenLoginView, SignupView, UserProfileDeleteView
