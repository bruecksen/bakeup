...
class MultiFormMixin(ContextMixin):
    ...
    def forms_invalid(self, forms):
        context_data = self.get_context_data(forms=forms)
        context_data['first_invalid_form'] = next((key for key, form in forms.items() if form.is_bound and not form.is_valid()), None)
